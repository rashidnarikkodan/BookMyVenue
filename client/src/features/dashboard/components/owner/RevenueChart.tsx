        ...
        >
          <defs>
            ...
            <filter id="lineShadow" x="-10%" y="-10%" width="120%" height="120%">
              <feDropShadow dx="0" dy="4" stdDeviation="4" floodColor="var(--color-warning)" floodOpacity="0.35" />
            </filter>
          </defs>
          ...
          <Line
            ...
            strokeWidth={3}
            dot={{ r: 4.5, stroke: 'var(--color-warning)', strokeWidth: 2, fill: 'var(--color-card)' }}
            activeDot={{ r: 6.5, stroke: 'var(--color-warning)', strokeWidth: 2, fill: 'var(--color-card)' }}
